...
class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
    ...
    public Object visitSetExpr(Expr.Set expr) {
        ...
        if (!(object instanceof LoxInstance)) {
            throw new RuntimeError(expr.name, "Only instances hae fields");
        }
    ...
    // counts the number if dcopes between the current scope and the scope
    ...
    // executes a list of statements in the cntext of a given environment
    ...
    public Void visitFunctionStmt(Stmt.Function stmt) {
        // for actual function declarations, isInitializer is false, but for methods, we
        // check the name
    ...
    private Object lookUpVariable(Token name, Expr expr) {
        // globals are resolved differently hence the name locals
        // hence if we don't find a distance in the map, it must be global
        Integer distance = locals.get(expr);
        if (distance != null) {
